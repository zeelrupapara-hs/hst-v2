...
type OAuth2 struct {
	...
	// OnInvalidate runs when a session or a login is revoked, on every instance.
	...
	// instanceId tells this process's own broadcasts apart from the others', since redis delivers a publish back to the sender too
	instanceId string
