...
const (
	...
	RouteFlags_stoplimit           RouteFlags = 0x00000400
	RouteFlags_sl                  RouteFlags = 0x00000800
	RouteFlags_tp                  RouteFlags = 0x00001000
	RouteFlags_stopout_order       RouteFlags = 0x00002000
	RouteFlags_stopout_position    RouteFlags = 0x00004000
...
const (
	...
	RouteCondition_market_deviation      RouteCondition = 3
	...
	RouteCondition_market_deviation_spr  RouteCondition = 11
...
const (
	ConditionRule_eq          ConditionRule = 0
	ConditionRule_not_eq      ConditionRule = 1
