...
func (s *HttpServer) CreateClient(c *fiber.Ctx) error {
	...
	s.notifyClient(c.UserContext(), view.ClientId, model.ActionCreated, view)
...
func (s *HttpServer) UpdateClient(c *fiber.Ctx) error {
	...
	s.notifyClient(c.UserContext(), int64(id), model.ActionUpdated, client)
...
func (s *HttpServer) DeleteClient(c *fiber.Ctx) error {
	...
	s.notifyClientIn(groups, int64(id), model.ActionDeleted,
