...
func (s *Server) CreateGroup(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_groups, logger.CodeOK, journal.GroupCreatedMsg(v.Group), v)
...
func (s *Server) DeleteGroup(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_groups, logger.CodeWarn, journal.GroupDeletedMsg(path), ref)
