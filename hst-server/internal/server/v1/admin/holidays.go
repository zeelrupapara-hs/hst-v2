...
func (s *Server) CreateHoliday(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_holidays, logger.CodeOK, journal.HolidayCreatedMsg(int(out.HolidayId)), out)
...
func (s *Server) UpdateHoliday(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_holidays, logger.CodeOK, journal.HolidayUpdatedMsg(int(out.HolidayId)), out)
...
func (s *Server) DeleteHoliday(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_holidays, logger.CodeWarn, journal.HolidayDeletedMsg(id), ref)
...
func (s *Server) ReorderHolidays(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_holidays, logger.CodeOK, journal.HolidayReorderedMsg(), body)
