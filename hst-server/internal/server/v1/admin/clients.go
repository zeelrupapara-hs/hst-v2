...
func (s *Server) CreateClient(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_clients, logger.CodeOK, journal.ClientCreatedMsg(view.ClientId), view)
...
func (s *Server) UpdateClient(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_clients, logger.CodeOK, journal.ClientUpdatedMsg(int64(id)), client)
...
func (s *Server) DeleteClient(c *fiber.Ctx) error {
	...
	s.JournalEntry(c, model.JournalType_clients, logger.CodeWarn, journal.ClientDeletedMsg(int64(id)), ref)
