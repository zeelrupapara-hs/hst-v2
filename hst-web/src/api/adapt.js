...
export const adaptSymbol = (s) => {
  ...
  return {
    ...
    margin_buy: s.margin_rate_initial_buy,
    margin_sell: s.margin_rate_initial_sell,
    maintenance_margin_buy: s.margin_rate_maintenance_buy,
    maintenance_margin_sell: s.margin_rate_maintenance_sell,
    margin_spec: s.margin_spec,
    swap_rates: {
      sunday: s.swap_rate_sunday,
      monday: s.swap_rate_monday,
      tuesday: s.swap_rate_tuesday,
      wednesday: s.swap_rate_wednesday,
      thursday: s.swap_rate_thursday,
      friday: s.swap_rate_friday,
      saturday: s.swap_rate_saturday,
    },
    swap_year_day: s.swap_year_day,
    swap_flags: s.swap_flags,
